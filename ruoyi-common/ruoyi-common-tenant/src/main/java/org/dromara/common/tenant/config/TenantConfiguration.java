...
import org.dromara.common.mybatis.config.MybatisFlexConfiguration;
...
public class TenantConfiguration {
    ...
    @ConditionalOnBean(MybatisFlexConfiguration.class)
    @AutoConfiguration(after = {MybatisFlexConfiguration.class})
    static class MybatisFlexConfig {
        /**
         * 多租户插件
         */
        @Bean
